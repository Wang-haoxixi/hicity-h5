<template>
	<view class="w-picker-view">
		...
		<picker-view v-if="fields=='month'" class="d-picker-view" :indicator-style="itemHeight" indicator-class="pickerList" :value="pickVal" @change="handlerChange">
			<picker-view-column>
				<view class="w-picker-item" indicator-class="pickerListItem" v-for="(item,index) in range.years" :key="index">{{item}}年</view>
			</picker-view-column>
			<picker-view-column>
