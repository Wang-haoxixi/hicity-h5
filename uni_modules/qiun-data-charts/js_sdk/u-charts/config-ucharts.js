...
module.exports = {
	...
	"formatter": {
		...
		"yAxisDemo3": function(val) {
			return val + '笔'
		},
		"yAxisDemo4": function(val) {
			return '￥'+val
		},
		...
		"tooltipDemo1": function(item, category, index, opts) {
			...
			if(typeof(opts.series[0].data[index])=="number"){
				...
				return "￥" + opts.series[0].data[index].value
			}
		},
		"tooltipDemo2": function(item, category, index, opts) {
			return category
		},
		"tooltipDemo3": function(item, category, index, opts) {
			// console.log(typeof(opts.series[0].data[index]))
			if(typeof(opts.series[0].data[index])=="number"){
				return item.data
			}else{
